...
def desc():
    ...
    Developers (Club Rocket Power) assume no liability and are not responsible for any misuse or damage caused by this program.
    '''+W)
    des = input('Yes/no:')
    if des.lower() == 'yes':
        pass
...
|__| |__||_______||___| |_|  |___|
    """+R+'Author: Club Rocket Power'+W
    banner2 = G+"""
             """+R+'Coder: r0cketp0wer'+G+"""
